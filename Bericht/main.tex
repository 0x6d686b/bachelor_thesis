...
\centering 
  \begin{tabular}{| c | l | r | >{\color{red}} r |}
    ...
    \multirow{1}{*}{} & \textbf{Planung} & \textbf{ 5 Tage} & \textbf{Tage}  \\ \cline{2-4} \hline \hline
     & \textbf{Implementierung} & \textbf{ 78 Tage} & \textbf{Tage}  \\ \hline
     ...
     Nr. 7& \textbf{Testing / Finetuning} & \textbf{ 12 Tage} & \textbf{ Tage}  \\ \hline \hline
     ...
     & \textbf{Zeitaufwand insgesamt} & \textbf{ 120 Tage}  & \textbf{ Tage} \\ \hline \hline
  \end{tabular}
