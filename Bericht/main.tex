...
\centering 
  \begin{tabularx}{\textwidth}{| l | X | l| X | }
    ...
    \cellcolor{hellgrau}\textbf{Abhängigkeiten} & Keine&  \cellcolor{hellgrau}\textbf{Verantwortung} & Mathias Hablützeli\\ \hline
  \end{tabularx}
...
\centering 
  \begin{tabularx}{\textwidth}{| l | X | l| X | }
    ...
    \cellcolor{hellgrau} & \multicolumn{3}{l |}{•	Erfassung des Windfeldes. Quelle: stündige Vorhersagedaten des COSMO-2 Modells}  \\ 
    \cellcolor{hellgrau} & \multicolumn{3}{l |}{•	Interpolation auf des Entscheidungsnetzes (zwei mögliche Methoden)} \\ 
     \multirow{-3}{*}{\textbf{\cellcolor{hellgrau}Beschreibung}} & \multicolumn{3}{l |}{•	Test: Darstellung des Windfeldes auf dem Entscheidungsnetz, pro Vorhersagefrist.} \\ \hline
...
\centering 
  \begin{tabularx}{\textwidth}{| l | X | l| X | }
    ...
    \cellcolor{hellgrau} & \multicolumn{3}{l |}{•	}  \\ 
    \cellcolor{hellgrau} & \multicolumn{3}{l |}{•	} \\ 
     \multirow{-3}{*}{\textbf{\cellcolor{hellgrau}Beschreibung}} & \multicolumn{3}{l |}{•	} \\ \hline
